    ...
    <div class="w-full sm:max-w-md px-8 py-6 bg-black bg-opacity-80 text-white shadow-lg rounded-lg backdrop-blur-md">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div class="flex items-center">
                <input id="remember_me" type="checkbox" name="remember" class="rounded border-gray-300 text-blue-500 focus:ring focus:ring-blue-400">
                <label for="remember_me" class="ml-2 text-sm">Se souvenir de moi</label>
            </div>
